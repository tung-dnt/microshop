...
pnpm add @shared/utils @shared/constants @shared/database @shared/config @shared/providers class-validator@0.14.0 dayjs@1.11.10 drizzle-orm@0.29.1 lodash@4.17.21 class-transformer@0.5.1 --filter ${workspace}
