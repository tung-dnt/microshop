<p align="center">
  <a href="https://www.medusa-commerce.com">
    <img alt="Microshop" src="https://i.imgur.com/USubGVY.png" width="100" />
  </a>
</p>
<h1 align="center">
  Microshop Starter Default
</h1>
<p align="center">
This repo provides the skeleton to get you started with using <a href="https://github.com/medusajs/medusa">Microshop</a>. Follow the steps below to get ready.
</p>
<p align="center">
  <a href="https://github.com/medusajs/medusa/blob/master/LICENSE">
    <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="Microshop is released under the MIT license." />
  </a>
...
- Install the Microshop CLI
  ```
  npm install -g @medusajs/medusa
  yarn global add @medusajs/medusa
  ```
- Create a new Microshop project
  ```
...
Your local Microshop server is now running on port **9000**.

### Seeding your Microshop store

---

To seed your Microshop store run the following command:
...
### Seeding your Microshop store with Docker

---

To add seed data to your Microshop store running with Docker, run this command in a seperate terminal:
