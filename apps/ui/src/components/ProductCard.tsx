    ...
    <div className="rounded-lg bg-white shadow-[-2px_2px_15px_-1px_rgba(113,_113,_113,_0.12)] overflow-hidden flex flex-col items-end justify-start py-[0.889rem] pr-[0.889rem] pl-[0rem] box-border gap-[0.861rem] w-auto [align-self:unset] h-auto text-left text-[0.889rem] text-black font-web-button-lg hover:bg-white hover:flex hover:w-auto hover:[align-self:unset] hover:h-auto hover:flex-col hover:gap-[15.5px] hover:items-end hover:justify-start hover:rounded-lg hover:py-4 hover:pr-4 hover:pl-0 hover:box-border hover:shadow-[-2px_2px_15px_-1px_rgba(113,_113,_113,_0.12)]">
      <div className="self-stretch h-[10.556rem] relative flex w-auto gap-[0rem] items-start justify-start [transform:rotate(0deg)] hover:flex hover:self-stretch hover:w-auto hover:h-[190px] hover:gap-[0px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)]">
        <div className="absolute top-[0rem] left-[0.889rem] flex flex-row items-end justify-start pt-[0.778rem] pb-[0.833rem] pr-[0rem] pl-[1.056rem] box-border gap-[0.444rem] w-auto [align-self:unset] h-auto hover:flex hover:w-auto hover:[align-self:unset] hover:h-auto hover:flex-row hover:gap-[8px] hover:items-end hover:justify-start hover:pt-3.5 hover:pb-[15px] hover:pr-0 hover:pl-[19px] hover:box-border">
          ...
          />
          <div className="h-[4.778rem] flex flex-col items-start justify-start w-auto [align-self:unset] gap-[0rem] [transform:rotate(0deg)] hover:flex hover:w-auto hover:[align-self:unset] hover:h-[86px] hover:flex-col hover:gap-[0px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)]">
        ...
        <button className="cursor-pointer [border:none] py-[0.222rem] px-[0.333rem] bg-bisque absolute top-[0rem] left-[0rem] rounded-tl-none rounded-tr-lg rounded-br-lg rounded-bl-none overflow-hidden flex flex-row items-start justify-start box-border w-auto [align-self:unset] h-auto gap-[0.556rem] z-[1] hover:bg-bisque hover:flex hover:w-auto hover:[align-self:unset] hover:h-auto hover:flex-row hover:gap-[10px] hover:items-start hover:justify-start hover:rounded-tl-none hover:rounded-tr-lg hover:rounded-br-lg hover:rounded-bl-none hover:py-1 hover:px-1.5 hover:box-border">
          <div className="relative text-[0.889rem] leading-[1.333rem] font-light font-web-button-lg text-secondary text-left flex min-w-[37] hover:font-light hover:font-web-button-lg hover:text-base hover:leading-[24px] hover:text-left hover:text-secondary hover:flex hover:min-w-[37]">
            -10%
          </div>
        </button>
      </div>
      ...
      />
      <div className="w-[14.222rem] flex flex-col items-start justify-start gap-[0.889rem] h-auto hover:flex hover:w-64 hover:h-auto hover:flex-col hover:gap-[16px] hover:items-start hover:justify-start">
