 ...
 * @param {boolean} isErrorPageHidden - Optional. If true, hides the error page when the user is not authenticated.
 * @returns {Function} The HOC that wraps the given component.
 */
export function withAuth(
  Component: any,
  isErrorPageHidden?: boolean,
) {
  return function HOC(props: any) {
    ...
    if (isErrorPageHidden) return null
