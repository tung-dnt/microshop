...
const DesktopCart: FunctionComponent = () => {
  return (
    <div className="relative bg-white flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[0.111rem] box-border gap-[2.222rem] leading-[normal] tracking-[normal] h-auto mq450:gap-[1.111rem_2.222rem]">
      <FrameComponent9 />
      <FrameComponent7 />
      <section className="self-stretch flex flex-row items-start justify-center pt-[0rem] px-[1.111rem] pb-[0.889rem] box-border max-w-full w-auto h-auto gap-[0rem] [transform:rotate(0deg)] hover:flex hover:self-stretch hover:w-auto hover:h-auto hover:flex-row hover:gap-[0px] hover:items-start hover:justify-center hover:[transform:rotate(0deg)] hover:pt-0 hover:px-5 hover:pb-4 hover:box-border hover:max-w-full">
        <div className="w-[68rem] flex flex-col items-start justify-start gap-[1.333rem] max-w-full h-auto [transform:rotate(0deg)] hover:flex hover:w-[1224px] hover:h-auto hover:flex-col hover:gap-[24px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)] hover:max-w-full">
          <FrameComponent6 />
          <FrameComponent4 />
        </div>
      </section>
      <footer className="self-stretch h-[19.278rem] flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[3rem] box-border max-w-full w-auto gap-[0rem] text-left text-[0.889rem] text-neutral-gray-cbcbcb font-web-button-lg hover:flex hover:self-stretch hover:w-auto hover:h-[347px] hover:flex-col hover:gap-[0px] hover:items-start hover:justify-start hover:pt-0 hover:px-0 hover:pb-[54px] hover:box-border hover:max-w-full mq700:pb-[1.944rem] mq700:box-border mq900:h-auto">
        ...
        <div className="self-stretch bg-primary-primary-900 box-border overflow-hidden flex flex-row flex-wrap items-start justify-between py-[0.889rem] pr-[6.611rem] pl-[6.028rem] min-h-[58] shrink-0 [debug_commit:1de1738] max-w-full gap-[1.111rem] w-auto h-auto text-[0.667rem] border-t-[2px] border-solid border-primary-primary-900 hover:bg-primary-primary-900 hover:flex hover:self-stretch hover:w-auto hover:h-auto hover:flex-row hover:flex-wrap hover:gap-[20px] hover:items-start hover:justify-between hover:py-4 hover:pr-[119px] hover:pl-[108.5px] hover:box-border hover:min-h-[58] hover:shrink-0 hover:[debug_commit:1de1738] hover:max-w-full mq700:pl-[1.111rem] mq700:pr-[1.111rem] mq700:box-border mq450:pl-[3rem] mq450:pr-[3.278rem] mq450:box-border">
          ...
          <div className="w-[26.611rem] flex flex-col items-start justify-start pt-[0.25rem] px-[0rem] pb-[0rem] box-border max-w-full h-auto gap-[0rem] [transform:rotate(0deg)] hover:flex hover:w-[479px] hover:h-auto hover:flex-col hover:gap-[0px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)] hover:pt-[4.5px] hover:px-0 hover:pb-0 hover:box-border hover:max-w-full">
            <div className="self-stretch flex flex-row items-start justify-between gap-[1.111rem] w-auto h-auto hover:flex hover:self-stretch hover:w-auto hover:h-auto hover:flex-row hover:gap-[20px] hover:items-start hover:justify-between mq450:flex-wrap">
